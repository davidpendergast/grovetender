...
def do_it():
    ...
    dist_dir = pathlib.Path("dist/grovetender_{}_{}".format(
        pretty_os_str.lower(), os_bit_count_str.lower()))
    ...
    dist_dir_subdir = pathlib.Path("{}/Grovetender".format(dist_dir))
    ...
    if os_system_str == _LINUX:
        ...
        exe_path = pathlib.Path("{}/Grovetender".format(dist_dir_subdir))
